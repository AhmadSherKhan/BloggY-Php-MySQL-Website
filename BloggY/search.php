...
if(isset($_GET['search']) && isset($_GET['submit'])){
    ...
    $search = $_GET['search'];
    $query="SELECT users.username, users.avatar, posts.id, posts.title, posts.body, posts.thumbnail, posts.date_time,categories.name
    FROM users
    JOIN posts ON users.id = posts.author_id
    JOIN categories ON posts.category_id = categories.id WHERE title LIKE '%$search%' ORDER BY date_time DESC";
            ...
            <?php
                    ...
                    if (isset($_SESSION['username'])) {
                       $username= $_SESSION['username'];
                        ...
                        <a href="user-profile.php" class="user-name">' .$username. '</a>
